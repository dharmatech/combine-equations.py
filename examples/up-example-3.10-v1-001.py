...
display_equations_(tmp, values, want=d1.pos.x)
display_equations_(tmp, values, want=d1.pos.y)

eq_1 = tmp[0] # d_0_v_mag*cos(d_0_v_angle) = d_1_x/d_1_t
eq_2 = tmp[1] # d_0_v_mag*sin(d_0_v_angle) = d_1_y/d_1_t + g*d_1_t/2
...
display_equations_(tmp, values, want=m1.pos.y)
