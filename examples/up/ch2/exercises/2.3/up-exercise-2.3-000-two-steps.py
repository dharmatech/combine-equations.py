...
# ca_1_x = -ca_0_t*v_av_x_ca_0_1 + ca_0_x + ca_1_t*v_av_x_ca_0_1
# ca_1_x = 192.5*kilometer

tmp = solve_and_display_(eqs, values, want=ca1.pos.x, return_solutions=True)
...
values[cb1.pos.x] = tmp[0][1].rhs  # distance from first trip
